...
description: 'Orientation for the development process this plugin packages: how a project''s docs tree is organised, how the product is specified against a Tier 1 contract, how the plan is kept, and how the gate proves the set is whole. Read when the user asks "what is dev-process-kit", "how does the spec process work", "what is a Tier 1 document", "what is the difference between tier 1 and tier 2", "what do these UR identifiers mean", "why does the contract have a gate", "how should the docs folder be structured", or arrives from numaco-setup wanting to know what this plugin does and what it needs configured. Names the parts and their owners, says what the plugin writes into a project and what it never touches, and routes to docs-vault, tier-1-contract, or project-plan for the actual work.'
metadata:
  status: stable
