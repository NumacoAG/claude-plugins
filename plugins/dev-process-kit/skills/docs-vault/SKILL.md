---
name: docs-vault
description: 'Create or maintain the project''s shared documentation tree: active drafts, closed versions, and final Tier 1 contracts. Use when setting up project docs or organizing the docs vault. Follow the canonical lifecycle and identifier rules; review rounds belong to review-kit.'
metadata:
  status: stable
