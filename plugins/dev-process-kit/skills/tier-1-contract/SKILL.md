...
description: Create or review the Tier 1 product specification and Definition of Done. Use for normative requirements, component boundaries, operator journeys, frozen identifier registries, clause splitting, or the fail-closed contract gate.
metadata:
  status: stable
