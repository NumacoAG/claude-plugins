---
name: project-plan
description: Create or update the living project plan tied to the Tier 1 contract, requirements, journeys, gates, evidence, and acceptance status. Use when planning implementation, updating progress, or assessing what remains before delivery.
metadata:
  status: stable
