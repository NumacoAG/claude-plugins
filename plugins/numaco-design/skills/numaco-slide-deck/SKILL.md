...
description: Create or edit a Numaco branded 1920x1080 slide deck and its print-ready PDF using the shared templates, renderer, and brand assets. Use for presentations, training, proposals, and customer decks; preserve the requested language and verify the final PDF.
metadata:
  status: beta
