...
description: Synchronize tracked Markdown documents between the user's configured laptop and mobile Obsidian vaults. Use for mobile review, vault reconciliation, conflicts, recovery, or sync setup. Synchronization is opt-in and must preserve both sides of divergent edits.
metadata:
  status: stable
